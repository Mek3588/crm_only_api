...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    await queryInterface.changeColumn('policereports', 'vehicleDamageDescription', {
      type: Sequelize.STRING,
      allowNull: false,
    });
    await queryInterface.changeColumn('policereports', 'vehicleCargoAmountDuringAccident', {
      type: Sequelize.DOUBLE,
      allowNull: false,
    });
    await queryInterface.changeColumn('policereports', 'damageDescription', {
      type: Sequelize.STRING,
      allowNull: false,
    });
